            ...
            steps {
                script {
                    withCredentials([string(credentialsId: 'GH', variable: 'TOKEN')]){
                        ...
                        echo $TAG_MSG
                    curl -o release.json -X POST https://api.github.com/repos/Romain-GUILLEMOT/WhispyrBack/releases \\
              ...
              withCredentials([string(credentialsId: 'GH', variable: 'TOKEN')]){
                  sh '''
                   ...
                   curl -o asset.json -X POST \
                                    ...
                                    -H "Accept: application/vnd.github+json" \
                                    "https://uploads.github.com/repos/Romain-GUILLEMOT/WhispyrBack/releases/$ID/assets?name=WhispyrBack"
                       '''
                   }
            }
          }
